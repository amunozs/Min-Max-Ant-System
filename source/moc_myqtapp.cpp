...
struct qt_meta_stringdata_myQtApp_t {
    QByteArrayData data[5];
    char stringdata[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_myQtApp_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_myQtApp_t qt_meta_stringdata_myQtApp = {
    {
...
QT_MOC_LITERAL(4, 23, 5)
    ...
    "myQtApp\0getPath\0\0solve\0clear\0"
};
...
void myQtApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        myQtApp *_t = static_cast<myQtApp *>(_o);
        switch (_id) {
...
const QMetaObject myQtApp::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_myQtApp.data,
      qt_meta_data_myQtApp,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myQtApp.stringdata))
